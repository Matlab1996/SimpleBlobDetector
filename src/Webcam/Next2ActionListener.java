...
public class Next2ActionListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		Panel.panel.setBackground(Color.ORANGE);
		...
		Panel.upper = new JSlider(10, 220, 100);
		...
		Panel.upper.setBackground(new Color(0, 255, 0));
		Panel.upper.setBounds(10, 290, 320, 45);
		Panel.panel.add(Panel.upper);
		
		
		Panel.back3.setBorderPainted(true);
		Panel.back3.setBorder(BorderFactory.createEtchedBorder(Color.BLUE , Color.BLUE));
		Panel.back3.setBackground(Color.BLACK);
		...
		Panel.next3.setBackground(Color.BLUE);
		Panel.next3.setBorderPainted(true);
		Panel.next3.setBorder(BorderFactory.createEtchedBorder(Color.BLUE , Color.BLUE));
